...
const SingleItem = ({ imgSrc, title, price, slug }) => {
    ...
    return (
        <div className='single-item
         min-w-[500px] min-h-[500px] overflow-hidden
            ...
            <div className="desc absolute bottom-[10%]
             -left-2 min-w-[120%] bg-dark-orange
              px-5 py-10 opacity-90 -rotate-2">
                <h3 className='text-green font-bold uppercase text-4xl pb-5'>{title}</h3>
                ...
                <h4 className='font-bold text-6xl
                 text-light-gray absolute right-40 bottom-10'>${price}</h4>
            </div>
        </div>
    );
}
